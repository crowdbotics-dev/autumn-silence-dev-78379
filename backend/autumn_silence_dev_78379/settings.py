"""
Django settings for autumn_silence_dev_78379 project.
...
ROOT_URLCONF = 'autumn_silence_dev_78379.urls'
...
WSGI_APPLICATION = 'autumn_silence_dev_78379.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "autumn_silence_dev_78379 API",
    "DESCRIPTION": "API documentation for autumn_silence_dev_78379 App",
    "VERSION": "v1",
}
